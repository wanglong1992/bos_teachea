		...
		<section class="mainsign">
			...
			<div class="signup" ng-app="signupApp" ng-controller="signupCtrl">
				<div class="col-md-9 signupbox">
					<form class="form col-md-6" id="customerForm"
						action="./customer_regiest.action">
						<div class=" form-group">
							<label for="inputaccount" class="col-sm-3 control-label"><b>*</b>手机号</label>
							<div class="col-sm-8">
								<input type="text" name="telephone" class="form-control"
									id="inputaccount" placeholder="请输入手机号" ng-model="telephone">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" name="checkcode" class="form-control"
									id="inputaccount" placeholder="请输入验证码" ng-model="code">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="password" name="password" class="form-control"
									id="inputaccount" placeholder="6-16位数字或英文字母">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="email" name="email" class="form-control"
									id="inputemail" placeholder="请输入需要绑定的邮箱">
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-8 song">
								<div class="checkbox">
									<label> <input type="checkbox"> 查看并同意<a
										href="#"> 《速运快递服务协议》</a>
									</label>
								</div>
						...
						<div class="form-group signbtn">
							<div class="col-sm-offset-3 col-sm-8 song">
								<a class="btn btn-danger"
									href="javascript:$('#customerForm').submit();">注册</a>
							</div>
						</div>
...
<script type="text/javascript">
	...
	// 控制器定义
	signupApp.controller("signupCtrl", [ "$scope", "$http",
			function($scope, $http) {
				$scope.btnMsg = "获取验证码";
				var active = true;
