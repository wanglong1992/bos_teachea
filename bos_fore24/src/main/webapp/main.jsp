	...
	<div class="seekimport">
		<div class="container">
			<ul class="list-inline">
				<li class="active">
					<img src="images/icon/suyun/icon1.png" alt="point1" />
					<p>运单追踪</p>
				</li>
				<li>
					<img src="images/icon/suyun/icon2.png" alt="point2" />
					<p>运费时效查询</p>
				</li>
				<li>
					<img src="images/icon/suyun/icon2.png" alt="point2" />
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-6 col-md-3">
				<div class="thumbnail">
					<img src="images/show/suyun/promotion1.png" alt="活动一">
			...
			<div class="col-sm-6 col-md-3">
				<div class="thumbnail">
					<img src="images/show/suyun/promotion3.png" alt="活动三">
			...
			<div class="col-sm-6 col-md-3">
				<div class="thumbnail">
					<img src="images/show/suyun/promotion4.png" alt="活动四">
		...
		<p class="text-center more">
			<a class="btn btn-danger" href="#/promotion" >更多活动促销</a>
		</p>
		...
		<div class="fresh">
			<div class="col-sm-6 col-md-6 left">
				<div class="media">
					<div class="media-left media-middle">
						<a href="#">
							<img class="media-object" src="images/show/suyun/tese1.png" alt="特色一">
						</a>
					</div>
			...
			<div class="col-sm-6 col-md-6 right">
				<div class="media">
					<div class="media-left media-middle">
						<a href="#">
							<img class="media-object" src="images/show/suyun/tese2.png" alt="特色一">
						</a>
					</div>
					<div class="media-body">
			...
			<div class="col-sm-6 col-md-6 left">
				<div class="media">
					<div class="media-left media-middle">
						<a href="#">
							<img class="media-object" src="images/show/suyun/tese3.png" alt="特色一">
						</a>
					</div>
					<div class="media-body">
			...
			<div class="col-sm-6 col-md-6 right">
				<div class="media">
					<div class="media-left media-middle">
						<a href="#">
							<img class="media-object" src="images/show/suyun/tese4.png" alt="特色一">
						</a>
					</div>
					<div class="media-body">
