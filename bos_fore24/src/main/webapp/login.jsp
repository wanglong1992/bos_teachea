			...
			<nav class="nav navbar-default">
				<div class="container">
					<div class="navbar-header">
						<a class="navbar-brand" href="./index.jsp"><img src="images/icon/logo.png"></a>
		...
		<section class="mainlogin"  ng-app="validationApp" ng-controller="mainController">
			<div class="container">
				<div class="col-md-4 col-md-offset-7 loginbox">
					<h4>用户登录</h4>
					<form class="form-horizontal" id="userForm" action="./customer_login.action" name="userForm" ng-submit="submitForm(userForm.$valid)" novalidate>
					...
					<p ng-show="userForm.password.$error.maxlength" class="help-block">用户名太长了！</p>
                        ...
                        <div class="col-md-offset-3 col-md-8">
							<a href="javascript:$('#userForm').submit();" class="btn btn-danger" >登录</a>
