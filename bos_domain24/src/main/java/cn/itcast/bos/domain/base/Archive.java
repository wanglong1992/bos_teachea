...
public class Archive {
	...
	public String toString() {
		return "Archive [id=" + id + ", archiveNum=" + archiveNum + ", archiveName=" + archiveName + ", remark="
				+ remark + ", hasChild=" + hasChild + ", operatingTime=" + operatingTime + ", operator=" + operator
				+ ", operatingCompany=" + operatingCompany + ", subArchives=" + subArchives + "]";
	}
