...
@Document(indexName="bos24",type="promotion")
public class Promotion implements Serializable {
	...
	public String getTitleImg() {
		...
		if (this.titleImg.startsWith(Constants.BOS_MANAGEMENT_HOST)) {
			return titleImg;
		}
	...
	public String getDescription() {
		...
		return description.replace("<img src=\"/bos_management",
				"<img src=\"" + Constants.BOS_MANAGEMENT_HOST + "/bos_management");
